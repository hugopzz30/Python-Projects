...
#Haz que el juego sea para dos jugadores y que cada uno pueda
# adivinar el precio del producto. Gana el jugador que diga el precio más cercano al original. El juego debe tener 5 rondas y como hemos dicho, dos jugadores. ¡GO!
#Permite que el usuario escoja la categoría, permite la elección
# entre 5 categorías diferentes.
